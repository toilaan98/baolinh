import styles from "./ReadOnlyRowBulongExport.module.scss";
...
function ReadOnlyRowBulongExport({ contact, index }) {
    ...
    const handleEditFormChange = (event) => {
        dispatch(bulongExportActions.handleGetId({ id: contact._id }));
        dispatch(bulongExportActions.handleEditFormChange(contact));
