...
import styles from "./EditableRowBulongExport.module.scss";
import classNames from "classnames/bind";
import { bulongExportActions, isClickActions } from "~/store";
const cx = classNames.bind(styles);
function EditableRowBulongExport({ data }) {
    const dispatch = useDispatch();

    const enteredBLExport = useSelector((state) => state.bulongExport);
    ...
    const handleAddFormChange = (event) => {
        ...
        dispatch(
            bulongExportActions.handleEnteredData({
    ...
    const handleUpdateData = (e) => {
        ...
        console.log(enteredBLExport);
        dispatch(
            bulongExportActions.handleUpdateData({
...
export default EditableRowBulongExport;
