...
import styles from "./EditableRowBulongXNT.module.scss";
import classNames from "classnames/bind";
import { bulongXntActions, isClickActions } from "~/store";
const cx = classNames.bind(styles);

function EditableRowBulongXNT({ data }) {
    const dispatch = useDispatch();

    const enteredBLExport = useSelector((state) => state.bulongXNT);

    console.log(enteredBLExport);
    const handleAddFormChange = (event) => {
        ...
        dispatch(
            bulongXntActions.handleEnteredData({
    ...
    const handleUpdateData = (e) => {
        ...
        console.log(enteredBLExport);
        dispatch(
            bulongXntActions.handleUpdateData({
                data: enteredBLExport,
                id: data._id,
            })
        );
...
export default EditableRowBulongXNT;
