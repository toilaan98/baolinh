...
import styles from "./EditableRowBulongNeed.module.scss";
import classNames from "classnames/bind";
import { bulongNeedActions, isClickActions } from "~/store";
const cx = classNames.bind(styles);
function EditableRowBulongNeed({ data }) {
    const dispatch = useDispatch();

    const enteredBLNeed = useSelector((state) => state.bulongNeed);
    const isEditData = useSelector((state) => state.click.handleGetId);
    console.log(enteredBLNeed);
    const handleAddFormChange = (event) => {
        ...
        dispatch(
            bulongNeedActions.handleEnteredData({
    ...
    const handleUpdateData = (e) => {
        ...
        console.log(enteredBLNeed);
        dispatch(
            bulongNeedActions.handleUpdateData({
                data: enteredBLNeed,
                id: data._id,
            })
        );
...
export default EditableRowBulongNeed;
